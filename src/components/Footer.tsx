        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <img src="/Figures/Nexus AI_TWO - Logotipo (1) 4.svg" alt="Noxus AI Logo" className="h-8 w-auto" />
              <span className="text-2xl font-bold text-white">Noxus IA</span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="https://wa.me/558596437539" className="text-slate-300 hover:text-white transition-colors duration-200">
                  Loja Virtual com IA
                </a>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center space-x-3">
                ...
                <span className="text-slate-300">noxuservices@gmail.com</span>
              </li>
              <li className="flex items-center space-x-3">
                <Phone className="h-4 w-4 text-slate-400" />
                <span className="text-slate-300">(85) 9643-7539</span>
              </li>
              <li className="flex items-center space-x-3">
                <MapPin className="h-4 w-4 text-slate-400" />
                <span className="text-slate-300">Ceará, Brasil</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-slate-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="https://www.instagram.com/noxus.ia/" className="text-slate-400 hover:text-white transition-colors duration-200">
              ...
              <a href="https://wa.me/558596437539" className="text-slate-400 hover:text-white transition-colors duration-200">
